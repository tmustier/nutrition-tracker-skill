...
source:
  ...
  menu_page: ""
  evidence:
    - "Kroger product label: https://www.kroger.com/p/optimum-nutrition-gold-standard-whey-double-rich-chocolate-protein-powder/0074892706014"
    - "USDA FoodData Central whey protein isolate: https://tools.myfooddata.com/nutrition-facts/173177/wt1"
    - "Research on whey protein micronutrients: https://www.nutritionadvance.com/whey-protein-nutrition-benefits/"
    - "Optimum Nutrition official support: https://support.optimumnutrition.com/en/support/solutions/articles/80000803097"
aliases: []
category: ingredient
portion:
  description: scoop (~30 g)
  est_weight_g: 30
  notes: Ranges provided; midpoints used where sensible.
assumptions:
  salt_scheme: normal
  oil_type: 
  prep: 
...
change_log:
  - timestamp: "2025-11-08T00:00:00+00:00"
    ...
    reason: "Updated cholesterol and iron values based on current product label verification"
    fields_changed: [cholesterol_mg, iron_mg, quality.confidence, version, last_verified]
    sources:
      - note: "Cholesterol: 35mg per scoop from multiple current retail product labels (Kroger, Smith's, Ralphs, Baker's 2024-2025)"
