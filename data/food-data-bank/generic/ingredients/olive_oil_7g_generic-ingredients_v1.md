...
```yaml
id: olive_oil_7g_generic-ingredients_v1
version: 1
...
category: ingredient
portion:
  description: "1/2 tablespoon (~0.5 tbsp)"
  est_weight_g: 7
...
notes:
  ...
  - "1 tablespoon = ~13.5g, so 1/2 tbsp = ~7g"
  ...
  - "Atwater check (available carb basis): 4×0.0 + 9×7.0 + 4×0.0 + 2×0.0 + 2.4×0.0 = 63.0 kcal (≈61.9 accounting for rounding)"
change_log:
