...
change_log:
  ...
  - timestamp: 2025-11-05T20:00:00+00:00
    ...
    data_quality: 'Per 100g values from USDA scaled to 74g portion. B-vitamin values consistent across multiple aggregators. Vitamin A from provitamin carotenoids (34 µg RAE per 100g). EPA/DHA zero (marine omega-3s absent in citrus). Iodine not measured in standard USDA citrus analysis.'
```
