...
3. **Add section header**:
   - Add section header (e.g., `## Dish Name (Venue)`) before the YAML block in `data/food-data-bank.md`
...
The script adds a new YAML block at the end and auto-regenerates the index file; review and commit the changes.
